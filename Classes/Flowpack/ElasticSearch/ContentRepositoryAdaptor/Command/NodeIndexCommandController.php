...
class NodeIndexCommandController extends CommandController {
	...
	protected function indexWorkspace($workspaceName) {
		...
		$executeCommand = function($workspaceName, $combination = NULL) {
			...
			$status = Scripts::executeCommand($this->getIndexWorkspaceWithDimensionsCommand(), $this->getFlowSettings(), TRUE, $arguments);
			if ($status !== TRUE) {
	 ...
	 * @return string
	 */
	protected function getIndexWorkspaceWithDimensionsCommand() {
		return 'flowpack.elasticsearch.contentrepositoryadaptor:nodeindex:indexworkspacewithdimensions';
	}
